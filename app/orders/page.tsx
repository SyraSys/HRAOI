            ...
            <div className="container mx-auto px-4 py-6 lg:py-8">
                ...
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
                    ...
                    <main className="lg:w-3/4">
                        {loading ? (
                            <div className="text-center py-12 lg:py-20 text-gray-400">Loading orders...</div>
                        ) : orders.length === 0 ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
                                {orders.map((order, i) => (
                                    ...
                                    >
                                        <span className="text-xs lg:text-sm font-medium text-[#1a1a5e] uppercase tracking-wide leading-tight group-hover:scale-105 transition-transform">
                                            {order.title}
                                        </span>
                                    </a>
                                ))}
