        ...
        <div className="bg-white min-h-screen">
            <div className="container mx-auto px-4 py-6 lg:py-8">
                ...
                <div className="mb-8 lg:mb-12">
                    <h2 className="text-xl lg:text-2xl font-bold text-primary-dark inline-block relative px-1">
                        Contact Us
                ...
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
                    ...
                    <aside className="lg:w-1/4 space-y-6 lg:space-y-8">
                        ...
                        {/* Blue Banner Box */}
                        <div className="bg-primary text-white p-4 lg:p-6 rounded-xl text-center shadow-md">
                    ...
                    {/* Contact Details & Map */}
                    <main className="lg:w-3/4 space-y-8 lg:space-y-12">
                        {/* Office Details Grid */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                            {/* Head Office */}
                            <div className="space-y-3 lg:space-y-4">
                                <h3 className="text-base lg:text-lg font-black text-primary-dark uppercase tracking-tight border-l-4 border-secondary pl-3">Administrative Office:</h3>
                                <div className="text-xs lg:text-sm text-gray-700 space-y-2 font-semibold">
                            ...
                            <div className="space-y-3 lg:space-y-4">
                                <h3 className="text-base lg:text-lg font-black text-primary-dark uppercase tracking-tight border-l-4 border-secondary pl-3">President Address:</h3>
                                <div className="text-xs lg:text-sm text-gray-700 space-y-2 font-semibold">
                        ...
                        <div className="space-y-4 lg:space-y-6">
                            <h3 className="text-lg lg:text-xl font-bold text-[#1a1a5e] uppercase tracking-tighter">We Are Here</h3>
                            <div className="w-full aspect-video bg-gray-100 rounded-xl lg:rounded-2xl overflow-hidden shadow-inner relative border border-gray-200">
                                <iframe
                                    width="100%"
                                    height="100%"
                                    style={{ border: 0 }}
