          ...
          <main className="lg:w-2/3 xl:w-3/4">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 min-h-[600px] flex flex-col">
              <div className="flex items-center justify-between mb-8 pb-4 border-b border-gray-100">
                <h2 className="text-2xl font-bold text-gray-900">Member Info</h2>
                {searched && !loading && (
              ...
              {error && !loading && (
                <div className="flex-1 flex flex-col items-center justify-center py-20 text-center bg-red-50/30 rounded-2xl border border-red-100/50">
