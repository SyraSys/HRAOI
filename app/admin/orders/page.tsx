            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <form onSubmit={handleUpload} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <button
                        type="submit"
                        disabled={uploading}
                        className="bg-[#242171] text-white px-6 py-2.5 cursor-pointer rounded-lg text-sm font-bold hover:bg-[#1a1a5e] transition-all disabled:opacity-60 flex items-center justify-center gap-2"
                    >
                        {uploading ? (
                            <>
                                <motion.div
                            ...
                            {items.map((item) => (
                                <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <button onClick={() => handleDelete(item.id)} className="text-red-500 hover:text-red-700 cursor-pointer text-sm font-semibold transition-colors">
                                            Delete
                                        </button>
                                    </td>
                                </tr>
